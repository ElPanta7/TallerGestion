          ...
          <div className={"col-R" + (mobView === "admin" && viewMode === "both" ? " mob-hide" : "")} style={viewMode === "client" ? { width: "100%" } : {}}>
            ...
            {!cliO ? (
              <div className="hero">
                ...
                <div style={{ color: "var(--mu)", fontSize: 14, marginBottom: 24, lineHeight: 1.5 }}>Ingresa el codigo que te enviamos por WhatsApp. En caso de "ERROR No se encontro una orden con ese codigo" presiona ver mi orden nuevamente.</div>
